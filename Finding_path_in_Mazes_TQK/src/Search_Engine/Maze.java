 ...
 *	Maze - class for representing search as a two-locational maze
 */
public class Maze {
	...
	/**
	 * The maze data is stored as a short integer rather than as a boolean
	 * A value of -1 indicates a barrier in the maze
	 */
	
	private short[][] maze;
	public Maze(int width, int height){
		System.out.println("New maze of size: " + width +" x " + height);
		this.width = width;
		this.height = height;
